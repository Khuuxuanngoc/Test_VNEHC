...
#include "kxnTaskTest_I2C_RFID.h"
...
kxnTaskTest_I2C_RFID kxnTaskTest_I2C_RFID1;
...
void setup() {
  ...
  Serial.println(F("START TEST I2C RFID! checkVoltageCurrent()"));

  if(Task_VNEHC_Test1.checkCurrent_mA(80) != VNEHC_List_Error_None)
  {
    // while(1);
  }

  Serial.println(F("START TEST I2C RFID!"));
